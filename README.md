...
`docker:dev` generate a docker image named wuzzuf-task and run it in a container. Run `docker:dev:start` for only start a container without build a new docker image
